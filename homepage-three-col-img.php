	...
	<div class="main">
		...
		<div class="box-container three-boxes">
			...
			<div class="box box-simple">
				...
				<p><img src="images/image1.png" width="117" height="63" alt="" class="img-left" />Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam interdum pharetra elit sit amet viverra. Mauris non sem odio, vitae interdum nulla. Vivamus bibendum adipiscing nulla, ac hendrerit felis ultric.
Duis posuere ante quis arcu ornare accumsan. Aenean consectetur odio sed nibh accumsan scelerisque. Etiam quam dolor, pellentesque ut euismod sagittis, aliquam ut felis.</p>
			...
			<div class="box box-simple last">
				...
				<p><img src="images/image2.jpg" width="262" height="138" alt=""  /></a></p>
			</div>
		</div>		
	</div>	
<?php
